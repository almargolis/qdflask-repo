...
Email notifications are provided by the separate `qdflaskemail` package. See the [qdflaskemail README](../qdflaskemail/README.md) for configuration and usage details.

```python
from qdflaskemail import init_qdflaskemail, send_to_admins, send_email

init_qdflaskemail(app)
send_to_admins(subject="Alert", body="Something happened.")
```
